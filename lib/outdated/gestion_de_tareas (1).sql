...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-07-2024 a las 22:07:57
...
(1, 'Andres', 'Cuevas', 'Zapata', 'cuevas@gmail.com', 25, 'Masculino', 1),
...
(15, 'Jabes', 'Llamas', 'Zamudio', 'yeibs.llamas@gmail.com', 19, 'Masculino', 2),
(16, 'Gustavo', 'Tello', 'Bernal', 'tello@gmail.com', 24, 'Masculino', 1),
(17, 'Marcos', 'Aguirre', 'Gonzalez', 'marcos@gmail.com', 19, 'Masculino', 1),
(18, 'Ricardo', 'Castro', 'Contreras', 'ricardo@gmail.com', 24, 'Masculino', 1),
(19, 'Brownie', 'Zapata', 'null', 'brownie@gmail.com', 20, 'Masculino', 1),
(20, 'Eduardo', 'Cuevas', 'Zapata', 'eduardo.cuevas@gmail.com', 30, 'Masculino', 1),
(21, 'Cinthia', 'Cuevas', 'Zapata', 'c.c@gmail.com', 28, 'Femenino', 1),
(22, 'Lizeth', 'Cuevas', 'Zapata', 'liz.c@gmail.com', 29, 'Femenino', 2);
...
CREATE TABLE `tarea` (
  ...
  `nombre` varchar(30) NOT NULL,
  `prio_Baja` varchar(10) DEFAULT NULL,
  `prio_Media` varchar(10) DEFAULT NULL,
  `prio_Alta` varchar(10) DEFAULT NULL,
...
INSERT INTO `tarea` (`Id_Tarea`, `nombre`, `prio_Baja`, `prio_Media`, `prio_Alta`, `descripcion`, `proyecto`) VALUES
(1, 'Diseñar logo', NULL, 'SI', NULL, 'Diseñar logo de la app con colores verdes y el nom', 1),
(2, 'Crear base de datos', NULL, NULL, 'SI', 'Diseñar y crear la base de datos para toda la apli', 1),
(3, 'LogIn', NULL, NULL, 'SI', 'Crear el LogIn para los usuarios. Incluir inicio d', 1),
(4, 'Interfaz clientes', NULL, NULL, 'SI', 'Codificar las acciones que pueda realizar el clien', 1),
(5, 'Interfaz administrador', NULL, NULL, 'SI', 'Codificar las acciones que pueda realizar el Admin', 1),
(6, 'Aplicación móvil', 'SI', NULL, NULL, 'Codificar la aplicación principal en móvil. Deben ', 1),
(7, 'Crear slogan', 'SI', NULL, NULL, 'Crear el slogan de la aplicación', 1),
(8, 'Conectar DB', NULL, NULL, 'SI', 'Una vez creada la base de datos, hacer la conexión', 1),
(9, 'Hacer pruebas', NULL, 'SI', NULL, 'Una vez listo, empezar a hacer pruebas', 1),
(10, 'Reportar bugs', NULL, 'SI', NULL, 'Tomar ss de la consola y enviar la descripción del', 1),
(11, 'Diseñar logo', NULL, 'SI', NULL, 'Diseñar logo de color azul incluyendo un Tow bar', 2),
(12, 'Crear base de datos', NULL, NULL, 'SI', 'Diseñar y crear la base de datos para toda la apli', 2),
(13, 'LogIn', NULL, NULL, 'SI', 'Crear el LogIn para los usuarios. Incluir inicio d', 2),
(14, 'Interfaz clientes', NULL, NULL, 'SI', 'Codificar las acciones que pueda realizar el clien', 2),
(15, 'Interfaz administrador', NULL, NULL, 'SI', 'Codificar las acciones que pueda realizar el Admin', 2),
(16, 'Aplicación móvil', 'SI', NULL, NULL, 'Codificar la aplicación principal en móvil. Deben ', 2),
(17, 'Crear slogan', NULL, 'SI', NULL, 'Crear el slogan de la aplicación', 2),
(18, 'Conectar DB', NULL, NULL, 'SI', 'Una vez creada la base de datos, hacer la conexión', 2),
(19, 'Hacer pruebas', NULL, 'SI', NULL, 'Una vez listo, empezar a hacer pruebas', 2),
(20, 'Reportar bugs', NULL, 'SI', NULL, 'Tomar ss de la consola y enviar la descripción del', 2);
...
INSERT INTO `usuario` (`Id_Usuario`, `privilegios`, `nombre_Usuario`, `contraseña`, `Id_Creador`, `equipo`, `persona`) VALUES
(1, 'Si', 'andres.1', 'cuevas.174', 1, 1, 1),
(2, 'No', 'alejandro.2', 'torres.450', 1, 2, 2),
(3, 'No', 'guillermo.3', 'martínez.719', 1, 2, 3),
(4, 'No', 'carlos.4', 'pérez.481', 1, 2, 4),
(5, 'No', 'carmen.5', 'torres.808', 1, 2, 5),
(6, 'No', 'luis.6', 'hernández.536', 1, 2, 6),
(7, 'No', 'beatriz.7', 'pérez.426', 1, 2, 7),
(8, 'Si', 'brandon.8', 'gonzalez.948', 8, 1, 8),
(9, 'No', 'diego.9', 'ortiz.537', 8, 2, 9),
(10, 'No', 'jorge.10', 'hernández.955', 8, 2, 10),
(11, 'No', 'francisco.11', 'ortiz.159', 8, 2, 11),
(12, 'No', 'daniela.12', 'castillo.756', 8, 2, 12),
(13, 'No', 'isabel.13', 'martínez.119', 8, 2, 13),
(14, 'No', 'juan.14', 'pérez.822', 8, 2, 14),
(15, 'No', 'jabes.15', 'llamas.989', 8, 2, 15),
(16, 'Si', 'gustavo.16', 'tello.455', 0, NULL, 16),
(17, 'Si', 'marcos.17', 'aguirre.8921', 0, NULL, 17),
(18, 'Si', 'ricardo.18', 'castro.7801', 0, NULL, 18),
(19, 'Si', 'brownie.19', 'zapata.678', 19, NULL, 19),
(20, 'Si', 'cinthia.21', 'cuevas.239', 20, NULL, 21),
(21, 'No', 'lizeth.22', 'cuevas.405', 20, NULL, 22);
...
--
ALTER TABLE `avance`
  ADD CONSTRAINT `avance_ibfk_1` FOREIGN KEY (`tarea`) REFERENCES `tarea` (`Id_Tarea`),
  ADD CONSTRAINT `avance_ibfk_2` FOREIGN KEY (`tablero`) REFERENCES `tablero` (`Id_Tablero`);
...
--
ALTER TABLE `tablero`
  ADD CONSTRAINT `tablero_ibfk_1` FOREIGN KEY (`equipo`) REFERENCES `equipo` (`Id_Equipo`);

--
-- Filtros para la tabla `tarea`
--
ALTER TABLE `tarea`
  ADD CONSTRAINT `tarea_ibfk_1` FOREIGN KEY (`proyecto`) REFERENCES `proyecto` (`Id_Proyecto`);

--
-- Filtros para la tabla `usuario`
--
ALTER TABLE `usuario`
  ADD CONSTRAINT `usuario_ibfk_1` FOREIGN KEY (`equipo`) REFERENCES `equipo` (`Id_Equipo`),
  ADD CONSTRAINT `usuario_ibfk_2` FOREIGN KEY (`persona`) REFERENCES `persona` (`Id_Persona`);
COMMIT;
