...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-07-2024 a las 08:03:41
...
INSERT INTO `usuario` (`Id_Usuario`, `privilegios`, `nombre_Usuario`, `contraseña`, `equipo`, `persona`) VALUES
(1, 'Si', 'andres.1', 'cuevas.174', 1, 1),
(2, 'No', 'alejandro.2', 'torres.450', 2, 2),
(3, 'No', 'guillermo.3', 'martínez.719', 2, 3),
(4, 'No', 'carlos.4', 'pérez.481', 2, 4),
(5, 'No', 'carmen.5', 'torres.808', 2, 5),
(6, 'No', 'luis.6', 'hernández.536', 2, 6),
(7, 'No', 'beatriz.7', 'pérez.426', 2, 7),
(8, 'Si', 'brandon.8', 'gonzalez.948', 1, 8),
(9, 'No', 'diego.9', 'ortiz.537', 2, 9),
(10, 'No', 'jorge.10', 'hernández.955', 2, 10),
(11, 'No', 'francisco.11', 'ortiz.159', 2, 11),
(12, 'No', 'daniela.12', 'castillo.756', 2, 12),
(13, 'No', 'isabel.13', 'martínez.119', 2, 13),
(14, 'No', 'juan.14', 'pérez.822', 2, 14),
(15, 'No', 'jabes.15', 'llamas.989', 2, 15),
(16, 'Si', 'gustavo.16', 'tello.455', NULL, 16);
