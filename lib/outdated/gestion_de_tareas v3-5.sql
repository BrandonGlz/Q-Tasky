...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-07-2024 a las 23:26:17
...
INSERT INTO `tarea` (`Id_Tarea`, `nombre`, `prio_Baja`, `prio_Media`, `prio_Alta`, `descripcion`, `proyecto`, `equipo`, `usuario`, `creador`) VALUES
(1, 'Diseñar logo', NULL, 'SI', NULL, 'Diseñar logo de la app con colores verdes y el nom', 1, 2, 0, 1),
(2, 'Crear base de datos', NULL, NULL, 'SI', 'Diseñar y crear la base de datos para toda la apli', 1, 1, 0, 1),
(3, 'LogIn', NULL, NULL, 'SI', 'Crear el LogIn para los usuarios. Incluir inicio d', 1, 1, 0, 1),
(4, 'Interfaz clientes', NULL, NULL, 'SI', 'Codificar las acciones que pueda realizar el clien', 1, 1, 0, 1),
(5, 'Interfaz administrador', NULL, NULL, 'SI', 'Codificar las acciones que pueda realizar el Admin', 1, 1, 0, 1),
(6, 'Aplicación móvil', 'SI', NULL, NULL, 'Codificar la aplicación principal en móvil. Deben ', 1, 1, 0, 1),
(7, 'Crear slogan', 'SI', NULL, NULL, 'Crear el slogan de la aplicación', 1, 2, 0, 1),
(8, 'Conectar DB', NULL, NULL, 'SI', 'Una vez creada la base de datos, hacer la conexión', 1, 1, 0, 1),
(9, 'Hacer pruebas', NULL, 'SI', NULL, 'Una vez listo, empezar a hacer pruebas', 1, 2, 0, 1),
(10, 'Reportar bugs', NULL, 'SI', NULL, 'Tomar ss de la consola y enviar la descripción del', 1, 2, 0, 1),
(11, 'Diseñar logo', NULL, 'SI', NULL, 'Diseñar logo de color azul incluyendo un Tow bar', 2, 4, 0, 8),
(12, 'Crear base de datos', NULL, NULL, 'SI', 'Diseñar y crear la base de datos para toda la apli', 2, 3, 0, 8),
(13, 'LogIn', NULL, NULL, 'SI', 'Crear el LogIn para los usuarios. Incluir inicio d', 2, 3, 0, 8),
(14, 'Interfaz clientes', NULL, NULL, 'SI', 'Codificar las acciones que pueda realizar el clien', 2, 3, 0, 8),
(15, 'Interfaz administrador', NULL, NULL, 'SI', 'Codificar las acciones que pueda realizar el Admin', 2, 3, 0, 8),
(16, 'Aplicación móvil', 'SI', NULL, NULL, 'Codificar la aplicación principal en móvil. Deben ', 2, 3, 0, 8),
(17, 'Crear slogan', NULL, 'SI', NULL, 'Crear el slogan de la aplicación', 2, 4, 0, 8),
(18, 'Conectar DB', NULL, NULL, 'SI', 'Una vez creada la base de datos, hacer la conexión', 2, 3, 0, 8),
(19, 'Hacer pruebas', NULL, 'SI', NULL, 'Una vez listo, empezar a hacer pruebas', 2, 4, 0, 8),
(20, 'Reportar bugs', NULL, 'SI', NULL, 'Tomar ss de la consola y enviar la descripción del', 2, 4, 0, 8);
