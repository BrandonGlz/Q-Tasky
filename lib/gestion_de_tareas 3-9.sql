...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 28-07-2024 a las 04:15:35
...
INSERT INTO `avance` (`Id_Avance`, `porcentaje`, `fecha`, `comentario`, `tarea`, `tablero`) VALUES
(1, 50, '2024-02-25', '', 1, 2),
...
CREATE TABLE `tablero` (
  ...
  `estado_No_Iniciado` int(11) DEFAULT 0,
  `estado_Iniciado` int(11) DEFAULT 0,
  `estado_Finalizado` int(11) DEFAULT 0,
...
(1, 'Diseñar logo', 'Diseñar logo de la app con colores verdes y el nom', 'Media', 2, 1, 2, 2, 1),
...
(4, 'Interfaz clientes', 'Codificar las acciones que pueda realizar el clien', 'Alta', 3, 1, 1, 3, 1),
...
(8, 'Conectar DB', 'Una vez creada la base de datos, hacer la conexión', 'Alta', 3, 1, 1, 4, 1),
(9, 'Hacer pruebas', 'Una vez listo, empezar a hacer pruebas', 'Media', 2, 1, 2, 0, 1),
(10, 'Reportar bugs', 'Tomar ss de la consola y enviar la descripción del', 'Media', 2, 1, 2, 5, 1),
...
(19, 'Hacer pruebas', 'Una vez listo, empezar a hacer pruebas', 'Media', 2, 2, 4, 9, 8),
(20, 'Reportar bugs', 'Tomar ss de la consola y enviar la descripción del', 'Media', 2, 2, 4, 10, 8);
...
(3, 'No', 'guillermo.3', 'martinez.719', 1, 3),
(4, 'No', 'carlos.4', 'perez.481', 1, 4),
(5, 'No', 'carmen.5', 'torres.808', 1, 5),
(6, 'No', 'luis.6', 'hernandez.536', 1, 6),
(7, 'No', 'beatriz.7', 'perez.426', 1, 7),
(8, 'Si', 'brandon.8', 'gonzalez.948', 8, 8),
(9, 'No', 'diego.9', 'ortiz.537', 8, 9),
(10, 'No', 'jorge.10', 'hernandez.955', 8, 10),
(11, 'No', 'francisco.11', 'ortiz.159', 8, 11),
(12, 'No', 'daniela.12', 'castillo.756', 8, 12),
(13, 'No', 'isabel.13', 'martinez.119', 8, 13),
(14, 'No', 'juan.14', 'perez.822', 8, 14),
